...
#run model
def fire(learning_rate, feature1, feature2, class1, class2, epochs, bais=0):
    ...
    #run
    mod=addline_model.Model(itration=epochs, learning_rate=learning_rate, withBaise=bais)
